                ...
                if (tile === TileType.MOUNTAIN) {
                    ...
                    if (isSpiderNest && h > 0.95 && h <= 0.985) {
                        ...
                        for (let i = 0; i < groupSize; i++) {
                            ...
                            const spawnKey = `${Math.floor(x + 0.5 + offX)},${Math.floor(y + 0.5 + offY)}`;
                            if (objects[spawnKey]) continue;
                    ...
                    // Cows
                    if (h > 0.992 && h < 0.996 && !objects[key]) {
                        entities.push({
                    ...
                    if (h > 0.997 && h < 0.999 && !objects[key]) {
                        entities.push({
