...
export const drawWorld = (
    ...
    const startCX = Math.floor(startCol / CHUNK_SIZE) - 1;
    const endCX = Math.floor(endCol / CHUNK_SIZE) + 1;
    const startCY = Math.floor(startRow / CHUNK_SIZE) - 1;
    const endCY = Math.floor(endRow / CHUNK_SIZE) + 1;
