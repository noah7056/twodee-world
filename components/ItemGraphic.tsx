    ...
    return (
        ...
        >
            ...
            {type === ItemType.COAL && (
                <g>
                    <path d="M10 24L16 12L32 8L40 20L36 36L20 40L8 32Z" fill="#57534E" stroke="#292524" strokeWidth="2" />
                    <circle cx="18" cy="20" r="3" fill="#171717" />
                    <circle cx="30" cy="18" r="2.5" fill="#171717" />
                    <circle cx="26" cy="30" r="3" fill="#171717" />
                </g>
            )}
            ...
            {type === ItemType.CAMPFIRE && (
                <g>
                    {/* Base logs - crossed */}
                    <rect x="8" y="30" width="32" height="6" rx="2" fill="#5D4037" stroke="#3E2723" strokeWidth="1" />
                    <rect x="8" y="30" width="32" height="6" rx="2" fill="#5D4037" stroke="#3E2723" strokeWidth="1" transform="rotate(90 24 33)" />
                    {/* Fire flames */}
                    <path d="M24 32 Q30 18 24 8 Q18 18 24 32Z" fill="#EF4444" />
                    <path d="M24 32 Q28 22 24 14 Q20 22 24 32Z" fill="#F59E0B" />
